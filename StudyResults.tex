...
\hypobox {Developers change 25\%-45\% of the logs across our studied applications. }
...
\begin{table}[t]
	\centering
	\smaller
	\caption{Time taken in days before for a new log into the application is changed}
