...
\begin{table}[tb]
	...
	\begin{tabular}{>{\centering}p{.1\textwidth}rrrr}
		\toprule 
...
\begin{figure}[tb]
	...
	\subfloat{\includegraphics[height=.6\columnwidth]
		{NumberofCommits}\label{fig:Feq} }
...
%	\centering
%	\smaller
%	\caption{The number of commits before a added logging statement is changed in the studied projects \cp{BOXPLOTS}}
%	
...
\hypobox {Developers change 25\%-45\% of the logging statements across our studied applications. }
