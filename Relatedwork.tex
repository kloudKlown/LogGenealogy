...
\subsection{Log Analysis and Tools}
...
All these prior research works rely on the stability of output logs for functionality. However, we find that logging statements are constantly changing which affects the results of log analysis and tools.  Our work attempts to explore the stability of logging statements, so developers and practitioners can import logging statements which are less likely to be changed and have no significant affect on the analysis. 
